  ...
  <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100" src="../habitaciones/IMG/suite especial1.jpg" alt="First slide"
          style="height: 800px; width: 1000px;">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="../habitaciones/IMG/suite especial2.jpg" alt="Second slide"
          style="height: 900px; width: 1250px; ">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="../habitaciones/IMG/suite especial3.jpg" alt="Second slide"
          style="height: 900px; width: 1250px; ">
      </div>
    </div>
  ...
  <div class="container1">
    <div class="grid-text">
      ...
      <div class="container">
        ...
        <div class="card">
          <div class="card-text">
            <i class="ICONS"><img src="img/Restaurant.png" alt=""></i>
        ...
        <div class="card">
          <div class="card-text">
            <i class="ICONS"> <img src="img/Beverage Alcohol-WF.png" alt="" width="35px"></i>
            <p>Licores</p>
          </div>
        </div>
        <div class="card">
          <div class="card-text">
            <i class="ICONS"> <img src="img/Loud Speaker-01-WF.png" alt="" width="35px"></i>
