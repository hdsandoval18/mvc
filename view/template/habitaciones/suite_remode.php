...
<head>
  ...
  <title>Suite Remodelada</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet"
    integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
  <link rel="stylesheet" href="../habitaciones/suite_remode.css">
  ...
  <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100" src="../habitaciones/IMG/suite renovada1.jpg" alt="First slide"
          style="height: 800px; width: 1250px;">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="../habitaciones/IMG/suite renovada2.jpg" alt="Second slide"
          style="height: 800px; width: 1250px; ">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="../habitaciones/IMG/suite renovada3.jpg" alt="Second slide"
          style="height: 800px; width: 1250px; ">
      </div>
    </div>
  ...
  <div class="container1">
    <div class="grid-text">
      ...
      <div class="container">
        ...
        <div class="card">
          <div class="card-text">
            <i class="ICONS"><img src="../habitaciones/IMG/IMG/Restaurant(1) (3).png" alt=""></i>
        ...
        <div class="card">
          <div class="card-text">
            <i class="ICONS"> <img src="../habitaciones/IMG/luz flourescente.png" alt="" width="35px"></i>
            <p>Luz flourescente</p>
          </div>
        </div>
        <div class="card">
          <div class="card-text">
            <i class="ICONS"> <img src="../habitaciones/IMG/nevera.png" alt="" width="35px"></i>
            <p>Refrigerador</p>
          </div>
        </div>
        <div class="card">
          <div class="card-text">
            <i class="ICONS"> <img src="../habitaciones/IMG/espacio amplio.png" alt="" width="35px"></i>
            <p>Espacio amplio</p>
          </div>
        </div>
        <div class="card">
      ...
      <div class="form_container">
        ...
        <div class="form_boton" style="text-align: center;">
          <a href="http://localhost:8080/mvc/view/template/indexI.php"
            style="text-align: center; align-self: center; height: 60px; color: white; text-decoration: none;"><button type="submit"
